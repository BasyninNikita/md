  ...
  Далее мы поговорим про основной функционал продукта и пройдемся по интерфейсу продукта. В самом верху страницы располагается полоска с доступными вкладками(___Дашборды, Сессии, Атаки, Сетевые связи, Узлы и Лента активностей___), чуть ниже - шкала активности трафика за прошедшее время. С ее помощью можно выбирать период, за который необходимо отобразить трафик. Сразу под ней располагается строка для ввода фильтров, по которым можно выбрать отдельные сессии. На фильтрах подробно останавливаться не будем, это тема для отдельной статьи.  
