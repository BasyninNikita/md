  ...
  В данной статье рассматривать весь функционал продукта мы не будем, пройдемся "по верхам" и покажем первые действия, которые можно(и нужно) сделать после его инсталляции. 
