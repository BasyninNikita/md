...
![filtr](screenc/Filtr1.png "Фильтр")  
...
![Two_filters](screenc/Two_filters.png "Фильтр")  
...
![Two_filters](screenc/and_or.png "Фильтр")
...
![Two_filters](screenc/and_or2.png "Фильтр")
...
![filtr](screenc/not.png "Фильтр")
В данном примере я захотел посмотреть все сессии, которые происходили не по протоколам HTTP или HTTPS.  
...
![filtr](screenc/Filtr1.png "Фильтр")  
Для более тонкой фильтрации полезно использовать несколько фильтров сразу, объединяя их, но тут самое главное - не запутаться в логике выражения.
